    ...
    return (
      <div className="p-2 min-w-[200px]">
        <div className="flex items-center gap-2 mb-1">
          ...
          {info.isMajor && <span className="px-1 py-0.5 bg-amber-100/50 text-amber-700 text-[9px] font-black rounded uppercase tracking-tighter">★ Major Station</span>}
        </div>
  ...
  return (
    <div className="p-3 min-w-[260px] max-w-[300px]">
      ...
      <div className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-2 flex items-center gap-1.5">
        <i className={info.timePeriod.icon}></i> {info.timePeriod.label} <span className="mx-1">•</span> UPDATED {info.lastUpdated}
      </div>
